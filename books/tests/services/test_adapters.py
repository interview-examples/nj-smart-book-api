...
class GoogleBooksAdapterTestCase(TestCase):
    ...
    def test_get_book_data_success(self):
        ...
        self.mock_service.to_enrichment_data.assert_called_once_with(
            self.sample_data, self.isbn
        )
    ...
    def test_search_books_success(self):
        ...
        self.mock_service.to_enrichment_data.side_effect = lambda item, isbn=None: (
            converted_results[0] if item else None
        )
