...
class GoogleBooksService(BookDataService):
    ...
    CACHE_TIMEOUT = getattr(settings, 'GOOGLE_BOOKS_CACHE_TIMEOUT', 14400)  # 4 hours default
    ...
    def search_books(self,
        ...
        elif author:  # Fallback to legacy author parameter if authors list is not provided
    ...
    def to_enrichment_data(self, volume_info: Dict[str, Any], base_isbn: str = "") -> BookEnrichmentData:
        """
        ...
        for identifier in volume_info.get('industryIdentifiers', []):
            ...
            identifiers.append(IndustryIdentifier(
                type=id_type,
