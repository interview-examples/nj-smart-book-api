...
class BookEnrichmentData:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'BookEnrichmentData':
        ...
        """
        identifiers = []
        raw_identifiers = data.get('industryIdentifiers') or data.get('industry_identifiers', [])

        if isinstance(raw_identifiers, list):
            for identifier in raw_identifiers:
                if isinstance(identifier, dict) and 'type' in identifier and 'identifier' in identifier:
    ...
    def merge(self, other: 'BookEnrichmentData') -> 'BookEnrichmentData':
        ...
        existing_identifiers = {(i.type, i.identifier) for i in self.industry_identifiers}
